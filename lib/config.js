...
// Q1 2026 monthly averages — verified actuals used as benchmark comparisons.
export const MARKETING_BENCHMARKS = {
  ...
  paidSearchLeads: 9.7,
  paidSearchCPL: 1552,
  paidSearchQualifyRate: 27.6,
  // LinkedIn (Paid Social) was not tracked in Q1 — new channel from June 2026.
};
