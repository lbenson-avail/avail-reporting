...
// The reps whose leads/deals/meetings represent the sales pipeline.
...
export const SALES_OWNERS = [
  ...
  // Covering while Steven is on paternity leave.
  { id: '186987020', name: 'Jaret Anderson', shortName: 'Jaret' },
];
...
export const MARKETING_DEFS = {
  totalLeads: {
    title: 'Total Leads',
    tooltip:
      'Lead records created in the period for the sales reps. Duplicates (same lead name + company) are counted once.',
  },
  qualifiedBuyers: {
...
export const METRIC_DEFS = {
  ...
  icpFits: {
    ...
    tooltip:
      'Count of leads in each ICP Fit Score category (Strong / Moderate / Weak / Not a Fit), for leads created in the selected period. Unscored counts ACTIVE leads only — disqualified leads without a score are not worth scoring, so they are excluded (the count matches the Unscored list below).',
  },
  reachingToConnected: {
