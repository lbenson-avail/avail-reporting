...
export const METRIC_DEFS = {
  ...
  meetingShowRate: {
    ...
    tooltip:
      'Meetings marked Completed divided by all meetings booked in the period (Completed + Scheduled + Rescheduled + No Show + Canceled). Outcome breakdown shown below.',
  },
  repBreakdown: {
    title: 'Rep vs Rep',
    tooltip:
      'Per rep: leads currently in each stage, total leads created in the period, and each rep’s share of all leads created.',
  },
  disqualifiedList: {
